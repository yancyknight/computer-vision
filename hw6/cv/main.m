...
% 
% figure;
% subplot(2,2,1), imshow(h1Hist);
% title('Horse 1');
% subplot(2,2,2), imshow(h2Hist);
% title('Horse 2');
% subplot(2,2,3), imshow(e1Hist);
% title('Elephant 1');
% subplot(2,2,4), imshow(e2Hist);
% title('Elephant 2');
...
disp('Matched with B = 30:');
disp(match30);

disp('Matched with B = 90:');
disp(match90);
